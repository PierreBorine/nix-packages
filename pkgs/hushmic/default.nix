# Credits: https://github.com/crowquillx/hushmic-nix
{
  lib,
  rustPlatform,
  fetchFromGitHub,
...
in
  rustPlatform.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "hushmic";
      tag = "v${version}";
      hash = "sha256-Tc3qg74PmsNNKLvvM2UGP6XLLVMBxo/uplwm2L/Cai4=";
    };

    cargoHash = "sha256-zYfAh8O4o/pVIMnbKnE3NtZecQI+bCNZVTZ7dyio5og=";
