...
| [libloot-cpp](github.com/loot/libloot)                                                   | A library for accessing LOOT's metadata and sorting functionality, cpp bindings.                                                                 |
| [loot](https://github.com/loot/loot)                                                     | Modding utility for some Bethesda games.                                                                                                         |
...
| [mo2-lint](https://github.com/Furglitch/modorganizer2-linux-installer)                   | An easy-to-use Mod Organizer 2 installer for Linux                                                                                               |
...
| [svg-to-ico](https://github.com/Ortham/svg_to_ico)                                       | Utility and Rust library to convert SVG icons into Windows ICO files                                                                             |
